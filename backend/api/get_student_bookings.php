...
try {
    ...
    foreach ($bookings as &$booking) {
        if (!empty($booking['foto'])) {
            $booking['tutor_foto_url'] = 'http://YOUR_SERVER_IP/etutor/assets/images/' . $booking['foto'];
        } else {
            $booking['tutor_foto_url'] = 'http://YOUR_SERVER_IP/etutor/assets/images/default-avatar.jpg';
        }
